...
<div class="row">
  <div class="col-md-6">
    <p style="color: #164D74;font-size:40px; margin-left:100px; font-weight:bolder; margin-top:30px">Indonesia 
      <br>
      First Choice in 
      <br>
      Dry Cleaning
...
<a href="/howorder"  type="button" class="btn btn-warning" style="background-color: #D16F36; margin-left: 100px; color:#ffff; width: 160px">LEARN MORE</a>
</div>
  <div class="col-md-6">
...
<table>
  <tr>
    <td>
    <img src=" {{asset('asset/1.png')}}" alt="" width="25" class="d-inline-block align-text-top" style=" margin-left : 100px; ">
    </td>
    <td>
...
<br>
<a href="/"  type="button" class="btn btn-primary" style="background-color:#72A4A5; margin-left: 100px; color:#ffff; width: 160px">Make an Order</a>
</div>
</div>
</div>
</section>
...
<div class="row">
  ...
  <div class="col-md-7">
    ...
    <a href="/"  type="button" class="btn btn-warning" style="background-color:#D16F36; margin-top:10px; margin-left: 100px; color:#ffff; width: 160px">Make an Order</a>
  </div>
  <div class="col-md-4">
