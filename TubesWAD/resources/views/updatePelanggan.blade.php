...
<div class="mb-3">
  ...
  <input type="text" name="nama_pelanggan" id="nama_pelanggan" value="{{ $pel->nama_pelanggan}}" class="form-control" id="exampleFormControlInput1" required>
</div>
<div class="mb-3">
...
<div class="mb-3">
  ...
  <input type="text" name="alamat" id="alamat" value="{{ $pel->alamat}}" class="form-control" id="exampleFormControlInput1" required>
</div>
<div class="mb-3">
