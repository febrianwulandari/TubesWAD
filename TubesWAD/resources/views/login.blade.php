...
<head>
    ...
    <title>Wools Laundry || Login Pelanggan</title>
...
<body  style="background-color: #E7FBFF;">
  ...
  <div class="mb-3" style="text-align: left;">
    ...
    <input type="email" class="form-control @error('email') is-invalid @enderror" id="exampleInputEmail1" name="email" aria-describedby="emailHelp" autofocus required value="{{ old('email') }}">
    @error('email')
